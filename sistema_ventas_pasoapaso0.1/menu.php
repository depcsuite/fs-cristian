...
<li class="nav-item">
  ...
  <div id="collapsecliente" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="cliente-listado.php">Listado de cliente</a>
    </div>
  </div>
</li>
<!-- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsedomicilios" aria-expanded="true" aria-controls="collapsecliente">
    <i class="fas fa-fw fa-cog"></i>
    <span>Domicilios</span>
  </a>
  <div id="collapsedomicilios" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item" href="domicilio-formulario.php">Nuevo domicilio</a>
      <a class="collapse-item" href="domicilio-listado.php">Listado de domicilio</a>
    </div>
  </div>
</li>
